...
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_SYM, RET),  U_LT(U_NUM, BSPC), U_LT(U_NAV, SPACE),U_LT(U_MOUSE, TAB),U_LT(U_MEDIA, ESC),U_NP,              U_NP
...
U_NP,              U_NP,              &kp DEL,           &kp RET,           &kp BSPC,          &kp SPACE,         &kp TAB,           &kp ESC,           U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_TAP_COLEMAKDH_FLIP \
&kp Q,             &kp W,             &kp F,             &kp P,             &kp B,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT,           \
&kp A,             &kp R,             &kp S,             &kp T,             &kp G,             &kp M,             &kp N,             &kp E,             &kp I,             &kp O,             \
&kp Z,             &kp X,             &kp C,             &kp D,             &kp V,             &kp K,             &kp H,             &kp COMMA,         &kp DOT,           &u_to_U_BASE,         \
U_NP,              U_NP,              &kp DEL,           &kp RET,           &kp BSPC,          &kp SPACE,         &kp TAB,           &kp ESC,           U_NP,              U_NP
...
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              &kp N0,            &kp MINUS,         &kp DOT,           U_NP,              U_NP
...
U_NP,              U_NP,              &kp DOT,           &kp MINUS,         &kp N0,            U_NA,              U_NA,              U_NA,              U_NP,              U_NP
